...
import { getBookDetails, submitReview } from '../api/books';
...
const handleSubmitReview = async (e) => {
    ...
    if (result.success) {
        ...
        // Update book data to show new average rating
        const updatedBook = {
            ...book,
            ...
            <div className="book-hero">
                <div className="book-hero-inner">
                    ...
                    <div className="book-info-col">
                        ...
                        {/* ADD TO LIBRARY - Now placed specifically below the synopsis */}
...
>
    {submitting ? 'Submitting...' : 'Submit Review'}
                ...
                {/* existing reviews list - will be populated from backend */}
