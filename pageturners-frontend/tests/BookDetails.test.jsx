...
import { submitReview, getBookDetails } from '../src/api/books';
...
describe('KLYRA-69: Review Form Validation', () => {
    ...
    <MemoryRouter initialEntries={['/books/book123']}>
        ...
        // Select 5 stars
        const starButtons = await screen.findAllByRole('button', { name: /Rate/i });
...
describe('KLYRA-118: Submit Review Integration', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(getBookDetails).mockResolvedValue({
            success: true,
            data: {
                _id: 'book123',
                title: 'Test Book',
